...
def sql_injection_scanner(url):
    ...
    #sql errors
    error_mesage = {"Access Database Engine", "check the manual that corresponds to your Drizzle server version", "check the manual that fits your Drizzle server version", "check the manual that corresponds to your MariaDB server version", "check the manual that fits your MariaDB server version", "check the manual that corresponds to your MySQL server version", "check the manual that fits your MySQL server version", "CLI Driver: DB2", "com.ibm.db2.jcc", "com.informix.jdbc", "com.microsoft.sqlserver.jdbc", "com.mysql.jdbc", "com.jnetdirect.jsql", "DB2Exception", "DB2 SQL error", "ERROR: parser: parse error at or near", "ERROR:sssyntax error at or near", "Exception: Informix", "ibm_db_dbi.ProgrammingError", "IfxException", "Informix ODBC Driver", "is not supported by MemSQL", "JET Database Engine", "macromedia.jdbc.oracle", "macromedia.jdbc.sqlserver", "MemSQL does not support this type of query", "MySqlClient.", "MySqlException", "MySQLSyntaxErrorException", "ODBC Informix driver", "ODBC Microsoft Access", "Oracle: Driver", "Oracle error", "OracleException", "oracle.jdbc", "org.postgresql.jdbc", "org.postgresql.util.PSQLException", "PG::SyntaxError:", "PostgreSQL: ERROR", "PostgreSQL query failed", "PSQLException", "quoted string not properly terminated", "SQL command not properly ended", "SQL Server", "SQLSrvException", "SQLServerException","SQLServer JDBC Driver", "SQL syntax: MySQL", "Npgsql.", "Syntax error (missing operator) in query expression", "unclosed quotation mark after the character string", "unsupported nested scalar subselect", "valid MySQL result", "valid PostgreSQL result", "warning: mysql", "Warning: Wifx_", "Warning: Wpg", "weblogic.jdbc.informix", "you have an error in your sql syntax", "Zend_Db_Adapter_Db2_Exception", "Zend_Db_Statement_Db2_Exception", "Zend_Db_Adapter_Mysqli_Exception", "Zend_Db_Statement_Mysqli_Exception", "Zend_Db_Adapter_Oracle_Exception", "Zend_Db_Statement_Oracle_Exception", "Zend_Db_Adapter_Sqlsrv_Exception," "Zend_Db_Statement_Sqlsrv_Exception"}

    #malicious sql code
    mal_sql = ["\"", "\'", "105; DROP TABLE Suppliers", "105 OR 1=1", str(" or ""=")]
